...
Güncelleyici içeren sürümlerde **Mola → Güncellemeleri kontrol et** menüsünü veya **Bildirimler ve uygulama → Uygulama güncellemeleri** bölümünü açın. Yardım bölümü ve uygulama içinde açılan indirme sayfası da yerel güncelleme penceresine erişim sağlar. Uygulama açılıştan yaklaşık bir dakika sonra ve altı saatte bir kararlı sürümleri kontrol eder; yeni sürüm menüde görünür, sistem izin veriyorsa sessiz bir bildirim gösterilir. Kontrol ve indirme görüşmeyi kesmez. **Güncellemeyi indir** ile ilerlemeyi izleyin; indirmeyi iptal edip tekrar başlatabilirsiniz. Tamamlanan dosyalar tekrar kullanılırken de doğrulanır. İptal edilen yarım indirme baştan başlar.

Mac'te ve AppImage'da **Güncelle ve yeniden aç**, Windows ve Debian/Ubuntu'da **Kurulumu başlat** ayrı bir onay ister. Onayladığınızda kurulum için Mola kapanır; öncesinde açık görüşmenizi bitirip gönderilmemiş mesajınızı kontrol edin. Kullanıcı profili ve sunucu adresi silinmez.

- **macOS 1.0.8 ve sonrası:** Güncelleme uygulamada indirilir ve doğrulanır. Paket sürümü, uygulama kimliği, işlemci mimarisi ve imzası kontrol edilir. Onaydan sonra Mola kapanır, yerel güncelleme yardımcısı uygulama paketinin tamamını değiştirir ve Mola'yı yeniden açar. DMG'yi Finder'da açmak veya uygulamayı elle sürüklemek gerekmez. Mola, kurulu olduğu klasörden çalışmalı; uygulamanın kendisine ve üst klasörüne yazma izni bulunmalıdır. Disk imajından veya App Translocation konumundan çalıştırılıyorsa önce Uygulamalar klasörüne kurulması istenir. Hazırlık hatasında çalışan uygulama korunur. Değiştirme veya yeniden açma başarısız olursa önceki sürüm geri yüklenmeye çalışılır; kurtarma kopyası kurulumun yanındaki `.mola-update-…/Mola.app` konumunda korunur. Ad-hoc imza Developer ID/noter onayı değildir: macOS yeniden açılışta güvenlik onayı isteyebilir. Gatekeeper ve quarantine bilgisi kaldırılmaz; gerekirse yukarıdaki macOS kurulum rehberini izleyin.
...
**İlk geçiş:** Güncelleyici bulunmayan 1.0.5 ve önceki sürümlerde 1.0.8 veya daha yeni kurulum dosyasını bir kez elle indirip kurun. Mac'teki 1.0.6/1.0.7 güncelleyicisi dosyayı uygulamada indirir, ancak son adımda DMG açar: 1.0.8'e ilk geçişte Mola'yı Uygulamalar klasörüne sürükleyerek değiştirin. Yeni güncelleyici kurulduktan sonraki güncellemeler uygulama içinden tamamlanır. Web arayüzünü yenilemek eski masaüstü kabuğuna bu yeteneği eklemez. Geliştirme ortamındaki paketlenmemiş Electron çalıştırmaları ve desteklenmeyen mimariler güncellenmez.
