  ...
  return (
    <TooltipPrimitive.Root
      ...
      onOpenChange={(open, details) => {
        // Hints must not consume the Escape key meant for the enclosing
        // navigation drawer, modal, or conversation surface.
  ...
  return (
    <TooltipPrimitive.Portal container={portalContainer}>
      <TooltipPrimitive.Positioner
        ...
        className="mola-tooltip-positioner isolate z-50"
      >
