                        ...
                        <>
                          ...
                          {data.workspace.isDemo && (
                            <p className="adm-hint">
                              Davet göndermek için kendi çalışma alanını
                              oluştur. Örnek ekip herkese açık bir deneme
                              alanıdır.
                            </p>
                          )}
                          {inviteUrl && (
                            ...
                            onDeleteWorkspace && (
                              <section className="adm-settings-section workspace-danger-zone">
                                ...
                                <p>
                                  ...
                                  kalıcı olarak silinir. Hesaplar ve diğer
                                  çalışma alanları korunur.
                                </p>
                                <Button
                                  variant="outline"
                                  size="unset"
            ...
            <form onSubmit={saveChannel}>
              ...
              {editing === "new" && (
                <>
                  <label>
                    Kanal türü
                    <NativeSelect unstyled name="kind" defaultValue="text">
